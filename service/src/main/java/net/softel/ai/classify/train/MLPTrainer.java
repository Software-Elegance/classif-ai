 ...
 */
public final class MLPTrainer {


private static final Logger logger = LoggerFactory.getLogger(MLPTrainer.class);
    ...
    public static TrainingResult trainMlp(String modelOutputDir) throws IOException, TranslateException {
        ...
        ImageFolder dataset = ImageFolder.builder()
            ...
            .optPipeline(
                ...
                new Pipeline()
                        ...
                        // .add(new RandomResizedCrop())
                        //.add(new RandomFlipLeftRight())
                        //.add(new RandomFlipTopBottom())
                        //.add(new Crop(x,y,NEW_WIDTH, NEW_HEIGHT))
                        //.add(new Normalize(mean, std))            //A Transform that normalizes an image NDArray of shape CHW or NCHW.
                        // .add(new RandomBrightness(brightness))
                        // .add(new RandomHue(hue))
                        .add(new ToTensor())
